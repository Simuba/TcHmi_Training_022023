...
declare module EcDiagnostics.Commons {
    class EcDiagnostics {
        constructor(elementRoot: HTMLElement, localization: Localization, commonPath: string, config: ClientConfig);
        ...
        private __symbolAccessSubscriptions;
...
declare module EcDiagnostics.Commons {
    ...
    interface WSCallbacks {
        callback?: WSCallback;
        firstCallback?: WSCallback;
        firstCall?: boolean;
        errorEl?: HTMLElement;
    }
    enum TcHmiServerError {
    ...
    abstract class Communication {
        ...
        abstract subscribe(symbol: string, writeValue: any, interval: number, callback: WSCallback, firstCallback?: WSCallback): number | null;
        ...
        protected processReadValue(command: any | undefined, callback?: WSCallback, firstCallback?: WSCallback, cbErrorEl?: HTMLElement): void;
    }
}
declare module EcDiagnostics.Commons {
...
declare module EcDiagnostics.Commons {
    ...
    class Topology {
        ...
        addRow(index: number, startWidth: number): MatrixRow;
...
declare module EcDiagnostics.Commons {
    class Master extends Component {
        ...
        updateSlavesScanned(data?: boolean | SlavesScannedIdentity): void;
...
declare module EcDiagnostics.Commons {
    class Slave extends Component {
        ...
        get processData(): Slave_ProcessData;
...
declare module EcDiagnostics.Commons {
    ...
    abstract class Drawing extends HTMLElement {
        ...
        addZoomLevel(zoomModification?: number): number;
        setZoomLevel(zoomLevel: number, checkLimits?: boolean): void;
        destroy(): void;
        ...
        drawFrame(dimension: Dimension, layers: Layers, color?: Color): void;
        drawLabel(labelPos: XY, design: ComponentDesign, manufacturer: string, type: string, warningLevel: number | undefined, layers: Layers): void;
...
declare module TcHmi.Controls.Beckhoff.TcHmiEcDiagnosticsClasses {
    class ControlCommunication extends EcDiagnostics.Commons.Communication {
        ...
        subscribe<T = any>(symbol: string, writeValue: T, interval: number, subscriptionCallback: EcDiagnostics.Commons.WSCallback, firstCallback: EcDiagnostics.Commons.WSCallback): number | null;
