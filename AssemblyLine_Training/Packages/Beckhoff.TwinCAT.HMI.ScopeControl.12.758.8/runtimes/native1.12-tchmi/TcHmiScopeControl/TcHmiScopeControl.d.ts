...
declare module TcHmi.Controls.Beckhoff.TcHmiScopeControl {
    ...
    module ReplacePrompt {
        interface LocalizableTexts {
            headerText: TcHmi.Controls.Helpers.Popup.Localization;
            contentText: TcHmi.Controls.Helpers.Popup.Localization;
            buttonTextCancel: TcHmi.Controls.Helpers.Popup.Localization;
            buttonTextReplace: TcHmi.Controls.Helpers.Popup.Localization;
            buttonTextIncrement: TcHmi.Controls.Helpers.Popup.Localization;
            toggleSwitchTextSave: TcHmi.Controls.Helpers.Popup.Localization;
        }
    }
}
